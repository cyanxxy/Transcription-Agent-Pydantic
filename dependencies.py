...
class TranscriptionDeps:
    ...
    temp_dir: str = field(default_factory=lambda: tempfile.mkdtemp(prefix="transcriber_"))
    max_retries: int = 3
    ...
    def get_google_model(self) -> GoogleModel:
        ...
        settings = GoogleModelSettings(
            ...
            # Enable thinking for complex transcription tasks
            google_thinking_config={
                'thinking_budget': self.thinking_budget
            } if self.thinking_budget != 0 else None
        )
        return GoogleModel(self.model_name, model_settings=settings)
