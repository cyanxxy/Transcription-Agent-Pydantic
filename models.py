...
class TranscriptResult(BaseModel):
    ...
    export_formats_available: List[str] = Field(default_factory=lambda: ["txt", "srt", "json"])
...
class TranscriptContext(BaseModel):
    ...
    speaker_names: List[str] = Field(default_factory=list, description="Names of speakers in the audio")
    topic: Optional[str] = Field(None, description="Main topic or domain of the conversation")
    technical_terms: List[str] = Field(default_factory=list, description="Technical terms or jargon to watch for")
    custom_instructions: Optional[str] = Field(None, description="Custom instructions for transcription")
    language_hints: Optional[str] = Field(None, description="Language or accent information")
    expected_format: Optional[str] = Field(None, description="Expected format (meeting, interview, lecture, etc.)")
    keywords: List[str] = Field(default_factory=list, description="Important keywords to watch for")
